...
bool UserInterface::addNewCar()
{
  while(true)
  {
    ...
    std::cin >> replyString;
    if(replyString=="Yes"||replyString=="yes"||replyString=="YES"||replyString=="Y"||replyString=="y")
    {
      return true;
    }
    else if (replyString=="No"||replyString=="no"||replyString=="NO"||replyString=="N"||replyString=="n")
    {
      return false;
    }
    else
    {
      std::cout << "did not recognise youre anser\n";
    }
  }
